...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    #
    # Inject is used to apply some opperation over the contents of the array.
    # Assumption is that its usually only for mathematical operations.
    # The results of the code block operation are stored and passed in as the sum|product
    # in the next pass.
    # The argument is the initial value of the stored value.
  end
